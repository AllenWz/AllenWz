...
| :--- | :--- |
| **Backend Specialization** | **Java (Spring Boot)**, Python, RESTful APIs |
| **System Design** | Distributed Systems, Scalable Architecture, Database Design |
| **Cloud & Deployment** | **AWS (SAA-C03 in progress)**, Lambda, SAM, S3, Git |
| **Frontend** | React.js (Full-stack integration) |

---

### 🚀 Featured Projects
* **E-commerce System (Current):** Developing a scalable backend architecture with integrated payment and order management.
* **Solar Energy Management:** Engineered a real-time monitoring system for energy distribution and efficiency tracking using **AWS Lambda** and a **Python** backend.
* **HR Management System:** Built a comprehensive platform for employee lifecycle management and payroll processing.
* **Inventory Management:** Built a system for inventory storage of corporate assets and streamlined the request/return process of inventory.
